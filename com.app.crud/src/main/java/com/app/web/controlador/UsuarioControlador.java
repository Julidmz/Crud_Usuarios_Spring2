...
//-------------------------------------------------------------------------------------------------------------------------------------
    ...
    // Si la contraseña del formulario está vacía, mantener la contraseña existente
    if (usuario.getContrasena() == null || usuario.getContrasena().isEmpty()) {
        usuario.setContrasena(usuarioExistente.getContrasena());
    } else {
        usuarioExistente.setContrasena(usuario.getContrasena()); // Actualizar si se proporcionó una nueva
    }
